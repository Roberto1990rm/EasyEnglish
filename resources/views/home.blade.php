    ...
    <div style="margin-top: -65px;" class=" py-16">
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="text-center">
                <h1 style="font-size: 60px;" class="fst-italic honk- mb-2  ">
                    Conoce EasyEnglish
                </h1>
            ...
            <div class="grid md:grid-cols-2 gap-10 mb-10 items-center">
                ...
                <div class="px-6 pt-6 pb-6 text-center rounded-xl shadow-md hover:shadow-xl transition duration-300"
                    style="background-color: blanchedalmond;">
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">¿Quiénes somos?</h2>
                    <p class="text-gray-700 leading-relaxed">
                        EasyEnglish nace del deseo de democratizar el aprendizaje del idioma inglés para todos, sin importar
                        edad o ubicación. Nuestro equipo está formado por docentes certificados, diseñadores instruccionales
                        y desarrolladores que creen en una educación accesible, interactiva y divertida.
                    </p>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16 text-center">
                <div class="bg-blue-50 rounded-lg p-6 shadow-md">
                    ...
                    <p class="text-gray-600">
                        Brindar herramientas de aprendizaje efectivas y accesibles para dominar el inglés desde cualquier
                        parte del mundo.
                    </p>
                </div>
                <div class="bg-blue-50 rounded-lg p-6 shadow-md">
