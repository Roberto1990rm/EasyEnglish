...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Crear Nueva Lección</h1>
    ...
    <form action="{{ route('lessons.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" name="video" class="form-control w-full border rounded p-2" placeholder="Pega la URL del video">
        </div>
        ...
        <button type="submit" class="btn bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">Crear lección</button>
        <a href="{{ route('courses.index') }}" class="btn bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded">Cancelar</a>
    </form>
</div>
